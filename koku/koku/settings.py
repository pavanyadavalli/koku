...
if "test" in sys.argv:
    ...
    CACHES = {
        ...
        "hostname": {"BACKEND": "django.core.cache.backends.locmem.LocMemCache", "LOCATION": TEST_CACHE_LOCATION},
    }
else:
    CACHES = {
        "default": {
        ...
        "hostname": {"BACKEND": "django.core.cache.backends.locmem.LocMemCache", "LOCATION": "unique-snowflake"},
    }
