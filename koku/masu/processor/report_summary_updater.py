...
class ReportSummaryUpdater:
    ...
    def __init__(self, customer_schema, provider_uuid, manifest_id=None, tracing_id=None):
        ...
        stmt = f"Starting report data summarization for provider uuid: {self._provider.uuid}."
    ...
    def _set_updater(self):
        ...
        return (
            report_summary_updater(self._schema, self._provider, self._manifest, self._tracing_id),
